...
import * as import21 from '../../lazyload-image/lazyload-image.directive';
...
class _View_ProductCardComponent0 extends import3.AppView<import0.ProductCardComponent> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this._LazyLoadImageDirective_5_3 = new import12.Wrapper_LazyLoadImageDirective(new import18.ElementRef(this._el_5),this.renderer);
    ...
    this._TemplateRef_25_5 = new import19.TemplateRef_(this._appEl_25,viewFactory_ProductCardComponent1);
    ...
    this._pipe_currency_0 = new import14.CurrencyPipe(this.parentInjector.get(import20.LOCALE_ID));
    ...
    this._pipe_number_1 = new import14.DecimalPipe(this.parentInjector.get(import20.LOCALE_ID));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import21.LazyLoadImageDirective) && (5 === requestNodeIndex))) { return this._LazyLoadImageDirective_5_3.context; }
    ...
    if (((token === import23.RouterLinkWithHref) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 27)))) { return this._RouterLinkWithHref_3_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_35:any = import2.interpolate(1,'',this.context.product.imgUrl,'');
    if (import2.checkBinding(throwOnChange,this._expr_35,currVal_35)) {
      this.renderer.setElementProperty(this._el_5,'src',this.viewUtils.sanitizer.sanitize(import24.SecurityContext.URL,currVal_35));
      this._expr_35 = currVal_35;
    }
    this._LazyLoadImageDirective_5_3.detectChangesInHostProps(this,this._el_5,throwOnChange);
    const currVal_36:any = import2.interpolate(1,'',this.context.product.title,'');
    if (import2.checkBinding(throwOnChange,this._expr_36,currVal_36)) {
      this.renderer.setText(this._text_10,currVal_36);
      this._expr_36 = currVal_36;
    }
    valUnwrapper.reset();
    const currVal_37:any = import2.interpolate(1,'',valUnwrapper.unwrap(import2.castByValue(this._pipe_currency_0_0,this._pipe_currency_0.transform)(this.context.product.discountedPrice,'USD',true,'1.0-0')),'');
    ...
    valUnwrapper.reset();
    const currVal_40:any = import2.interpolate(1,'',valUnwrapper.unwrap(import2.castByValue(this._pipe_currency_0_1,this._pipe_currency_0.transform)(this.context.product.regularPrice,'USD',true,'1.0-0')),'');
    if ((valUnwrapper.hasWrappedValue || import2.checkBinding(throwOnChange,this._expr_40,currVal_40))) {
      this.renderer.setText(this._text_19,currVal_40);
      this._expr_40 = currVal_40;
    }
    valUnwrapper.reset();
    const currVal_42:any = import2.interpolate(1,'',valUnwrapper.unwrap(import2.castByValue(this._pipe_number_1_0,this._pipe_number_1.transform)(this.context.product.discountPercentage,'3.1-5')),'');
    if ((valUnwrapper.hasWrappedValue || import2.checkBinding(throwOnChange,this._expr_42,currVal_42))) {
      this.renderer.setText(this._text_22,currVal_42);
