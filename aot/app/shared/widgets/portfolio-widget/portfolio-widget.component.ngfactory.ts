...
import * as import4 from '../../../../../app/shared/widgets/portfolio-widget/portfolio-widget.component';
...
var renderType_PortfolioWidgetComponent_Host:import0.RenderComponentType = (null as any);
class _View_PortfolioWidgetComponent_Host0 extends import1.AppView<any> {
  ...
  _PortfolioWidgetComponent_0_5:import4.PortfolioWidgetComponent;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('app-portfolio-widget',rootSelector,(null as any));
    ...
    this._PortfolioWidgetComponent_0_5 = new import4.PortfolioWidgetComponent(this._HttpClientService_0_4);
    this._appEl_0.initComponent(this._PortfolioWidgetComponent_0_5,[],compView_0);
    compView_0.create(this._PortfolioWidgetComponent_0_5,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.HttpClientService) && (0 === requestNodeIndex))) { return this._HttpClientService_0_4; }
    if (((token === import4.PortfolioWidgetComponent) && (0 === requestNodeIndex))) { return this._PortfolioWidgetComponent_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._PortfolioWidgetComponent_0_5.ngOnInit(); }
    this.detectContentChildrenChanges(throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
  }
}
function viewFactory_PortfolioWidgetComponent_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_PortfolioWidgetComponent_Host === (null as any))) { (renderType_PortfolioWidgetComponent_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
  return new _View_PortfolioWidgetComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const PortfolioWidgetComponentNgFactory:import11.ComponentFactory<import4.PortfolioWidgetComponent> = new import11.ComponentFactory<import4.PortfolioWidgetComponent>('app-portfolio-widget',viewFactory_PortfolioWidgetComponent_Host0,import4.PortfolioWidgetComponent);
const styles_PortfolioWidgetComponent:any[] = [import12.styles];
var renderType_PortfolioWidgetComponent:import0.RenderComponentType = (null as any);
class _View_PortfolioWidgetComponent0 extends import1.AppView<import4.PortfolioWidgetComponent> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
...
export function viewFactory_PortfolioWidgetComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import4.PortfolioWidgetComponent> {
  if ((renderType_PortfolioWidgetComponent === (null as any))) { (renderType_PortfolioWidgetComponent = viewUtils.createRenderComponentType('/home/craftsvilla/angular2-aot-webpack2-rollup/app/shared/widgets/portfolio-widget/portfolio-widget.component.html',0,import10.ViewEncapsulation.Emulated,styles_PortfolioWidgetComponent,{})); }
...
class _View_PortfolioWidgetComponent1 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_1:any = this._map_0(((this.context.index % 3) == 0));
    if (import5.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
...
function viewFactory_PortfolioWidgetComponent1(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
