...
import * as import4 from './+not_found/not-found.component.ngfactory';
import * as import5 from './+not_found/not-found.component';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import3.Injector) {
    super(parent,[import4.NotFoundComponentNgFactory],([] as any[]));
  }
  get _ROUTES_2():any[] {
      if ((this.__ROUTES_2 == (null as any))) { (this.__ROUTES_2 = [[
        {
          path: '404',
          component: import5.NotFoundComponent
        }
        ,
        {
          path: '**',
