...
import * as import22 from '../shared/widgets/mega-menu/mega-menu-link.component.ngfactory';
import * as import23 from '../shared/widgets/announcement-widget/announcement-widget.component.ngfactory';
import * as import24 from '../shared/widgets/category-widget/category-widget.component.ngfactory';
import * as import25 from '../shared/widgets/extra-menu/extra-menu.component.ngfactory';
import * as import26 from '../shared/widgets/hero-banner/hero-banner.component.ngfactory';
import * as import27 from '../shared/widgets/portfolio-widget/portfolio-widget.component.ngfactory';
import * as import28 from '../shared/widgets/storyline-widget/storyline-widget.component.ngfactory';
import * as import29 from '../shared/widgets/product-slider/product-slider.component.ngfactory';
import * as import30 from '../shared/widgets/testimonials-widget/testimonials-widget.component.ngfactory';
import * as import31 from '../shared/widgets/pagination/pagination.component.ngfactory';
import * as import32 from '../shared/widgets/product-card/product-card.component.ngfactory';
import * as import33 from './home.component.ngfactory';
...
import * as import39 from '../../../app/home/home.component';
...
class HomeModuleInjector extends import0.NgModuleInjector<import1.HomeModule> {
  ...
  __ROUTES_31:any[];
  __TRANSLATIONS_FORMAT_32:any;
  constructor(parent:import20.Injector) {
    super(parent,[
      import21.MegaMenuComponentNgFactory,
      import22.MegaMenuLinkComponentNgFactory,
      import23.AnnouncementWidgetComponentNgFactory,
      import24.CategoryWidgetComponentNgFactory,
      import25.ExtraMenuComponentNgFactory,
      import26.HeroBannerComponentNgFactory,
      import27.PortfolioWidgetComponentNgFactory,
      import28.StorylineWidgetComponentNgFactory,
      import29.ProductSliderComponentNgFactory,
      import30.TestimonialsWidgetComponentNgFactory,
      import31.PaginationComponentNgFactory,
      import32.ProductCardComponentNgFactory,
  ...
  get _APP_ID_15():any {
    if ((this.__APP_ID_15 == (null as any))) { (this.__APP_ID_15 = import34._appIdRandomProviderFactory()); }
  ...
  get _EventManager_19():import14.EventManager {
    if ((this.__EventManager_19 == (null as any))) { (this.__EventManager_19 = new import14.EventManager(this._EVENT_MANAGER_PLUGINS_18,this.parent.get(import37.NgZone))); }
  ...
  get _RootRenderer_23():any {
    if ((this.__RootRenderer_23 == (null as any))) { (this.__RootRenderer_23 = import38._createConditionalRootRenderer(this._DomRootRenderer_22,this.parent.get(import38.NgProbeToken,(null as any)))); }
  ...
  get _TRANSLATIONS_FORMAT_32():any {
    if ((this.__TRANSLATIONS_FORMAT_32 == (null as any))) { (this.__TRANSLATIONS_FORMAT_32 = (null as any)); }
    return this.__TRANSLATIONS_FORMAT_32;
  }
  createInternal():import1.HomeModule {
    ...
    this._Testability_11 = new import10.Testability(this.parent.get(import37.NgZone));
    this._ApplicationRef__12 = new import11.ApplicationRef_(this.parent.get(import37.NgZone),this.parent.get(import40.Console),this,this._ErrorHandler_9,this,this._ApplicationInitStatus_10,this.parent.get(import10.TestabilityRegistry,(null as any)),this._Testability_11);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import41.LOCALE_ID)) { return this._LOCALE_ID_7; }
    ...
    if ((token === import43.DOCUMENT)) { return this._DOCUMENT_16; }
    ...
    if ((token === import44.AnimationDriver)) { return this._AnimationDriver_21; }
    if ((token === import16.DomRootRenderer)) { return this._DomRootRenderer_22; }
    if ((token === import45.RootRenderer)) { return this._RootRenderer_23; }
    if ((token === import17.DomSanitizer)) { return this._DomSanitizer_24; }
    if ((token === import46.Sanitizer)) { return this._Sanitizer_25; }
    if ((token === import18.ViewUtils)) { return this._ViewUtils_26; }
    if ((token === import47.IterableDiffers)) { return this._IterableDiffers_27; }
    if ((token === import48.KeyValueDiffers)) { return this._KeyValueDiffers_28; }
    if ((token === import15.SharedStylesHost)) { return this._SharedStylesHost_29; }
    if ((token === import19.Title)) { return this._Title_30; }
    if ((token === import49.ROUTES)) { return this._ROUTES_31; }
    if ((token === import50.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_32; }
