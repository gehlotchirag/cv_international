...
import * as import0 from './storyline-widget.component';
...
export class Wrapper_StorylineWidgetComponent {
  context:import0.StorylineWidgetComponent;
  changed:boolean;
  constructor(p0:any) {
    this.changed = false;
    this.context = new import0.StorylineWidgetComponent(p0);
  }
...
var renderType_StorylineWidgetComponent_Host:import2.RenderComponentType = (null as any);
class _View_StorylineWidgetComponent_Host0 extends import1.AppView<any> {
  ...
  _StorylineWidgetComponent_0_5:Wrapper_StorylineWidgetComponent;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = import5.selectOrCreateRenderHostElement(this.renderer,'cvi-storyline-widget',import5.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    ...
    this._StorylineWidgetComponent_0_5 = new Wrapper_StorylineWidgetComponent(this._HttpClientService_0_4);
    this._appEl_0.initComponent(this._StorylineWidgetComponent_0_5.context,([] as any[]),compView_0);
    compView_0.create(this._StorylineWidgetComponent_0_5.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import4.HttpClientService) && (0 === requestNodeIndex))) { return this._HttpClientService_0_4; }
    if (((token === import0.StorylineWidgetComponent) && (0 === requestNodeIndex))) { return this._StorylineWidgetComponent_0_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._StorylineWidgetComponent_0_5.detectChangesInInputProps(this,this._el_0,throwOnChange);
    this.detectContentChildrenChanges(throwOnChange);
    this._StorylineWidgetComponent_0_5.detectChangesInHostProps(this,this._el_0,throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
  }
}
function viewFactory_StorylineWidgetComponent_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_StorylineWidgetComponent_Host === (null as any))) { (renderType_StorylineWidgetComponent_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_StorylineWidgetComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const StorylineWidgetComponentNgFactory:import11.ComponentFactory<import0.StorylineWidgetComponent> = new import11.ComponentFactory<import0.StorylineWidgetComponent>('cvi-storyline-widget',viewFactory_StorylineWidgetComponent_Host0,import0.StorylineWidgetComponent);
const styles_StorylineWidgetComponent:any[] = [import12.styles];
var renderType_StorylineWidgetComponent:import2.RenderComponentType = (null as any);
class _View_StorylineWidgetComponent0 extends import1.AppView<import0.StorylineWidgetComponent> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
...
export function viewFactory_StorylineWidgetComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<import0.StorylineWidgetComponent> {
  if ((renderType_StorylineWidgetComponent === (null as any))) { (renderType_StorylineWidgetComponent = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.Emulated,styles_StorylineWidgetComponent,{})); }
...
class _View_StorylineWidgetComponent1 extends import1.AppView<any> {
  ...
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement) {
    ...
    this._map_9 = import5.pureProxy1((p0:any):{[key: string]:any} => {
      return {last: p0};
    });
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_0_0_1:any = this._map_9((this.context.index == this.parent.context.last));
...
function viewFactory_StorylineWidgetComponent1(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
